...
À l'origine, l'objectif est de disposer d'un moyen d'action contre les autres organisations présentes sur Habbo.

Le principe repose sur une particularité du jeu : un propriétaire d'appartement peut accorder des **droits**, ou accréditations, à d'autres joueurs afin qu'ils puissent déplacer son mobilier.
...
Pendant la majeure partie de l'histoire du RPK, les cibles sont principalement :

- les mafias ;
- les gangs ;
- les organisations criminelles ;
- certaines organisations liées au RPK.
...
- se faire recruter ;
- gagner progressivement la confiance de ses dirigeants ;
- recevoir une accréditation dans un ou plusieurs appartements.

Cette phase peut être extrêmement courte pour une petite organisation peu structurée ou durer plusieurs mois dans le cas d'une organisation importante.

Certaines opérations historiques ont nécessité des infiltrations particulièrement longues.

En **2010**, les archives racontent par exemple le retour de **Valtieri** et **Moltisanti** après plus de **deux années d'infiltration** dans différentes familles et groupes d'influence.
...
La logique traditionnelle du saccage repose donc sur la confiance accordée volontairement au futur saccageur.

La réussite ne consiste pas uniquement à déplacer des meubles : une partie de la valeur symbolique du saccage provient précisément du fait que l'organisation ciblée a elle-même accordé suffisamment de confiance à son adversaire.
...
Selon les archives historiques, cette pratique aurait notamment été adoptée afin d'éviter que d'autres organisations puissent revendiquer un saccage réalisé par la MH.

La présence d'un sigle est également prise en compte dans certains systèmes de notation.

Lors de la Vendetta d'été 2010, par exemple :

- un petit saccage sans sigle rapporte 1 point ;
- le même saccage avec sigle MH rapporte 2 points.

Le sigle constitue donc à la fois :

- une signature ;
- une preuve symbolique de revendication ;
- un critère de qualité du saccage.
...
Le saccageur doit déplacer le mobilier de manière propre et organisée.

La méthode traditionnelle consiste à :

1. déplacer l'ensemble du mobilier autorisé ;
2. le regrouper soigneusement dans une partie de l'appartement ;
3. éviter autant que possible un résultat désordonné ;
4. former les lettres **MH** lorsque la quantité et le type de mobilier le permettent ;
5. préparer les éléments nécessaires à la capture finale.

Le saccage n'est donc pas conçu comme une simple destruction visuelle de l'appartement.

Le résultat doit au contraire être suffisamment propre pour être présenté comme une opération réussie sur le forum.
...
- l'identité du saccageur ;
- l'appartement ciblé ;
- l'organisation propriétaire ;
- l'existence des droits ;
- l'état du lieu avant l'opération ;
- l'état du lieu après l'opération.
...
La capture doit idéalement permettre de voir :

- le mobilier avant le saccage ;
- le nom ou la description de l'appartement ;
- l'identité du propriétaire ;
- les éléments permettant de rattacher la salle à l'organisation ciblée ;
- la preuve de l'accréditation lorsque celle-ci peut être montrée.

Lorsqu'un post-it est présent, il peut également servir de preuve supplémentaire.
...
Elle doit montrer autant que possible :

- l'appartement saccagé ;
- le mobilier déplacé ;
- le sigle MH lorsqu'il a été réalisé ;
- le profil ou l'identité du saccageur ;
- la description de l'appartement ;
- le post-it lorsque celui-ci est disponible.

Le résultat doit permettre aux responsables du forum de comprendre immédiatement ce qui a été réalisé.
...
Lorsqu'un saccageur dispose des droits nécessaires, les anciens messages peuvent être effacés et un post-it peut être modifié afin de laisser une revendication de la Mafia-Habbo.

La présentation du post-it fait partie du soin apporté au saccage.

Dans certaines compétitions, même des détails de présentation peuvent avoir une incidence sur la notation.

Lors de la Vendetta de 2010, l'absence d'un point final sur le post-it figure par exemple parmi les erreurs pouvant entraîner un malus.
...
Dans les règles tardives, un propriétaire absent depuis **plus de quinze jours** peut rendre le saccage invalide.

L'objectif est d'éviter que les membres accumulent artificiellement des saccages en ciblant des organisations ou appartements abandonnés depuis longtemps.
...
La Mafia-Habbo utilise différentes catégories afin de distinguer les petites opérations des opérations prestigieuses.

Pendant une longue période, les principales catégories sont notamment :
...
- d'une petite mafia ;
- d'un groupe récent ;
- d'une organisation disposant de peu de mobilier ;
- d'une structure ayant peu de membres ;
- d'un appartement peu développé.

Ces saccages constituent une part importante de l'activité des jeunes membres.

Ils permettent notamment aux Recrues de se familiariser avec :
...
Les critères historiques peuvent notamment prendre en compte :

- la taille de l'appartement ;
- la quantité de mobilier ;
- la richesse apparente ;
- la qualité de l'aménagement ;
- l'existence d'une véritable organisation interne.
...
Parmi les critères utilisés historiquement figurent notamment :

- un appartement important ;
- une quantité élevée de mobilier ;
- une organisation interne réelle ;
- une hiérarchie structurée ;
- un forum ou un support externe ;
- une certaine réputation dans le RPK.

Les annexes appartenant à une grande organisation peuvent également être évaluées en fonction de l'importance de l'organisation principale.
...
Ils concernent des organisations majeures et peuvent marquer durablement l'histoire du RPK.

Ils peuvent résulter :

- d'une longue infiltration ;
- du recrutement d'un membre important de l'organisation adverse ;
- d'une trahison ;
- d'une usurpation ;
- d'une opération organisée par plusieurs membres.

Ces opérations sont souvent conservées séparément dans les archives ou particulièrement mises en avant.

Parmi les organisations saccagées par la Mafia-Habbo au fil de son histoire figurent notamment :
...
- Sacra Corona Unita ;
- Winchester's ;
- différentes organisations plus petites.
...
Elle consiste notamment à exploiter une identité ou à se faire passer pour une autre personne afin d'obtenir la confiance de la cible.

La Mafia-Habbo revendique également un rôle dans le développement de cette technique au sein du RPK.

Un exemple notable apparaît en **août 2010**, lorsque la **Famille Vittoria** est saccagée grâce à une usurpation préparée par Sayc.

L'organisation ferme à la suite de cette opération.

Elle rouvre cependant quelque temps plus tard et subit un second saccage le **7 septembre 2010**, réalisé par Kronicles.
...
Dans la pratique, leur durée varie énormément.

De nombreux saccages peuvent être réalisés relativement rapidement lorsqu'une organisation accorde facilement ses droits.

Mais certaines opérations historiques reposent effectivement sur des infiltrations longues.

L'exemple de **Valtieri et Moltisanti**, revenus en 2010 après plus de deux années passées dans différentes organisations et groupes d'influence, constitue l'un des cas les plus spectaculaires mentionnés dans les archives.

Il ne faut cependant pas considérer qu'un grand saccage implique nécessairement plusieurs mois ou années d'infiltration.

Certains grands coups résultent plutôt d'une opportunité, d'une trahison ou du ralliement d'un membre déjà important de l'organisation adverse.
...
La Mafia-Habbo autorise notamment l'utilisation de la **dalle magique** dans certaines circonstances.

Son usage reste cependant encadré.
...
Des règles publiées sur le forum cherchent à définir différentes formes de fraude.
...
- l'appartement d'un de ses clones ;
- une organisation qu'il contrôle lui-même.
...
afin qu'il accorde volontairement ses droits pour permettre un saccage.
...
- un Voyou peut être rétrogradé Recrue ;
- une Recrue peut être renvoyée de la famille.

Les Vendettas comportent elles aussi des sanctions spécifiques en cas de tricherie.

Lors de la Vendetta de 2010, un faux saccage ou un manque grave de fair-play peut entraîner :

- la rétrogradation du membre responsable ;
...
Pendant une période relativement courte, les membres cherchent à réaliser le maximum de saccages possible.

Selon les éditions, ils peuvent être répartis en plusieurs équipes.

L'objectif est multiple :

- augmenter l'activité ;
- stimuler la compétition ;
- permettre aux jeunes membres de se faire remarquer ;
- renforcer les liens entre membres ;
- produire un grand nombre de saccages en peu de temps.

Les archives précisent cependant que la compétition ne doit pas faire disparaître l'une des quatre lois de la Mafia-Habbo :
...
### Groupe 1 — « Lallapalooza »

Responsable : Albierto.
...
Responsable : GladeSkins.

### Groupe 4 — « Il devastatore »

Responsable : John.McReary.

Les groupes peuvent évoluer avec l'arrivée de nouveaux participants.
...
Dans le sujet consacré à l'événement, celui-ci est présenté comme le symbole des meilleurs saccageurs de l'histoire de la Mafia-Habbo.

Les membres du groupe vainqueur reçoivent également un trophée destiné à être exposé dans le **Grand Palace**.

La Vendetta constitue donc à la fois :

- une compétition ;
- un moyen d'évaluer les membres ;
...
Ce système montre à quel point l'importance de la cible et la qualité de la réalisation peuvent faire varier la valeur d'un saccage.

Les Affranchis calculent les points accordés.
...
Parmi les erreurs citées figurent :

- l'absence du point final sur le post-it ;
- des téléporteurs bloqués ;
- un saccage réalisé sans clone lorsque celui-ci est requis.

Une erreur entraîne une pénalité de :

**-1 point**

L'inactivité manifeste d'un membre peut conduire à son exclusion du groupe.

La tricherie peut entraîner :
...
**120 saccages en une semaine.**

Parmi les meilleurs saccageurs figurent :
...
La chronologie générale de 2010 mentionne par ailleurs une période estivale plus large durant laquelle environ **300 saccages** auraient été comptabilisés en quelques semaines.

Ce chiffre ne correspond donc pas nécessairement au seul événement organisé du 23 au 30 août.
...
La chronologie de la Mafia-Habbo annonce un total de :
...
Les archives annoncent un résultat de :

**129 saccages en une semaine.**
...
Elle se termine au début du mois de janvier 2014.

Le bilan annoncé est de :
...
Pour une Recrue ou un Voyou, il constitue l'un des moyens les plus visibles de démontrer :

- son activité ;
- sa motivation ;
- sa capacité à infiltrer une organisation ;
- sa compréhension des règles ;
- son respect des procédures.

Le saccage n'est cependant pas le seul moyen de progresser.

La participation au forum, les idées, les activités internes, le comportement et la capacité de réflexion sont également valorisés.

Un exemple historique apparaît en **2011**.

**Valtieri**, alors Voyou, parvient à sigler à la fois la **Cosa Nostra** et la **Vizzini** pour la Mafia-Habbo.
...
Un saccage important peut servir à :

- humilier un adversaire ;
- montrer une infiltration réussie ;
- affaiblir sa réputation ;
- provoquer une crise interne ;
- encourager certains membres à quitter leur organisation ;
- marquer symboliquement une victoire.
...
À la fin de l'année 2017, les archives de la MH revendiquent sa **« destruction totale »**.

En novembre 2018, **Confringo** réalise un nouveau saccage presque intégral de la Bjork-Family.
...
Cette règle correspond à la **Mafia-Attitude** historique.

Les joueurs civils n'ont normalement pas vocation à être pris pour cible.

Cette règle change à la fin de l'année **2019**.
...
Cela signifie que les saccages peuvent également concerner des appartements appartenant à des joueurs ne faisant pas partie du RPK.

Certaines catégories restent cependant exclues, notamment les salles consacrées :
...
Les archives comprennent des opérations contre des dizaines d'organisations différentes et s'étendent sur plusieurs centaines de pages de forum.

Les sujets concernent aussi bien :

- de petites organisations ;
- des groupes éphémères ;
- des rivaux historiques ;
- de grandes familles structurées.

Cette masse documentaire montre que le saccage n'est pas une activité secondaire de la Mafia-Habbo.

Pendant une grande partie de son histoire, il constitue l'un des principaux moteurs de l'activité quotidienne de ses membres.
...
- stratégie ;
- réputation ;
- maîtrise technique de Habbo ;
- compétition ;
- mise en scène ;
- archivage sur forum.

Il permet également de comprendre pourquoi les forums occupent une place aussi importante dans le RPK.

Sans capture, sans publication et sans validation, le saccage perd une grande partie de sa valeur symbolique.

Le forum transforme ainsi une action temporaire réalisée dans un appartement Habbo en un événement pouvant être conservé plusieurs années dans les archives de l'organisation.
